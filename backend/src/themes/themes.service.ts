...
export class ThemesService {
  ...
  async updateMine(dto: UpdateThemeDto, user: AuthenticatedUser) {
    const theme = await this.prisma.vendorTheme.upsert({
      ...
      update: {
        ...
        storeNameAr: normalizeOptionalText(dto.storeNameAr),
        storeNameEn: normalizeOptionalText(dto.storeNameEn),
        ...
        storefrontTitleAr: normalizeOptionalText(dto.storefrontTitleAr),
        storefrontTitleEn: normalizeOptionalText(dto.storefrontTitleEn),
        storefrontDescription: normalizeOptionalText(dto.storefrontDescription),
        storefrontDescriptionAr: normalizeOptionalText(dto.storefrontDescriptionAr),
        storefrontDescriptionEn: normalizeOptionalText(dto.storefrontDescriptionEn),
  ...
  async serializeTheme(theme: Partial<VendorTheme> & { vendor?: { id: string; name: string; email: string; storeUsername: string | null; role: UserRole } }) {
    ...
    return {
      ...
      storeNameAr: theme.storeNameAr ?? null,
      storeNameEn: theme.storeNameEn ?? null,
      logoUrl,
      bannerUrl,
      storefrontImageUrl,
      storefrontTitle: theme.storefrontTitle ?? defaultTheme.storefrontTitle,
      storefrontTitleAr: theme.storefrontTitleAr ?? null,
      storefrontTitleEn: theme.storefrontTitleEn ?? null,
      storefrontDescription: theme.storefrontDescription ?? defaultTheme.storefrontDescription,
      storefrontDescriptionAr: theme.storefrontDescriptionAr ?? null,
      storefrontDescriptionEn: theme.storefrontDescriptionEn ?? null,
